...
func TestOpenAPIRoutesSchemasStatusesAndSecurityMatchServer(t *testing.T) {
	...
	contracts := map[string]openAPIRouteContract{
		...
		"/api/v1/auth/google/challenge": {http.MethodPost, "createGoogleChallenge", []string{"200", "429", "500", "503"}, true, "", "200", "application/json", "#/components/schemas/NativeChallengeResponse"},
		"/api/v1/auth/google/exchange":  {http.MethodPost, "exchangeGoogleIDToken", []string{"200", "400", "401", "429", "500", "503"}, true, "#/components/schemas/NativeExchangeRequest", "200", "application/json", "#/components/schemas/TokenResponse"},
		"/api/v1/auth/refresh":          {http.MethodPost, "refreshNativeTokens", []string{"200", "400", "401", "429", "500"}, true, "#/components/schemas/RefreshRequest", "200", "application/json", "#/components/schemas/TokenResponse"},
		"/api/v1/me":                    {http.MethodGet, "getCurrentUser", []string{"200", "401", "429", "500"}, false, "", "200", "application/json", "#/components/schemas/MeResponse"},
		"/api/v1/auth/logout":           {http.MethodPost, "logout", []string{"204", "401", "403", "429", "500"}, false, "", "", "", ""},
		"/api/v1/account":               {http.MethodDelete, "deleteAccount", []string{"204", "400", "401", "403", "429", "500"}, false, "#/components/schemas/DeleteAccountRequest", "", "", ""},
		"/api/v1/auth/revoke-device":    {http.MethodPost, "revokeDevice", []string{"204", "400", "401", "403", "429", "500"}, false, "#/components/schemas/RevokeDeviceRequest", "", "", ""},
		"/api/v1/bootstrap":             {http.MethodGet, "getBootstrapSnapshot", []string{"200", "401", "409", "429", "500"}, false, "", "200", "application/json", "#/components/schemas/SyncResponse"},
		"/api/v1/bootstrap/resolve":     {http.MethodPost, "resolveBootstrapHistory", []string{"200", "400", "401", "403", "409", "429", "500"}, false, "#/components/schemas/BootstrapResolutionRequest", "200", "application/json", "#/components/schemas/SyncResponse"},
		"/api/v1/sync":                  {http.MethodPost, "syncTimer", []string{"200", "400", "401", "403", "409", "429", "500"}, false, "#/components/schemas/SyncRequest", "200", "application/json", "#/components/schemas/SyncResponse"},
		"/api/v1/history":               {http.MethodGet, "getTimerHistory", []string{"200", "401", "409", "429", "500"}, false, "", "200", "application/json", "#/components/schemas/HistoryResponse"},
		"/api/v1/stream":                {http.MethodGet, "streamTimerRevisions", []string{"200", "401", "409", "429", "500"}, false, "", "200", "text/event-stream", ""},
	}
