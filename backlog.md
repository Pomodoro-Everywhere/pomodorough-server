...
Readiness snapshot refreshed: 2026-09-06 — suite published at `0.12.0`; `0.13.0` tag failed (CI run `34040281802`: Core pin `15cdd929…` is not a Core ref, one-char typo); `0.14.0` published (tag `v0.14.0` at `54770f5`, Core `20f9696b…`/`e83b0ed6…`, CI run `34050710605` + Release run `34050710626` success).
...
| --- | --- | --- |
| Apple iOS/macOS | Unsigned `0.12.0` published and independently verified; `0.13.0` tag failed, `0.14.0` target | Developer signing, TestFlight, Developer ID signing, and notarization are excluded by request |
| Android | API-36-targeting unsigned `0.12.0` published and independently verified; `0.13.0` tag failed, `0.14.0` target | Production-keystore signing is excluded by request |
| Desktop | Unsigned `0.12.0` published and independently verified; `0.13.0` tag failed, `0.14.0` target | Windows Authenticode signing is excluded by request |
...
| Go service | `0.12.0` published and independently verified with archives, SBOM, checksums, and attestations; `0.13.0` tag failed (CI run `34040281802`, nonexistent Core pin), `0.14.0` published (tag `v0.14.0` at `54770f5`, Core `20f9696b…`, CI + Release success) | Production SSH deployment and an authentic encrypted-backup restore remain externally blocked |
...
| P1.9 | Complete for supported unsigned scope | All four `0.12.0` releases passed clean builds, exact-set/checksum/attestation checks, supported clean-install/runtime smoke, publication, and independent fresh-download verification (server `87d12e5`, tag `v0.12.0` pushed, release workflow success); server `0.13.0` tag failed (CI run `34040281802`, nonexistent Core pin); server `0.14.0` published (tag `v0.14.0` at `54770f5`, Core `20f9696b9a7c5dd9f0a253b21a5c9bd225f9e9b2`, CI run `34050710605` + Release run `34050710626` success). |
